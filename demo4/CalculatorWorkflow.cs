...
namespace demo4
{
    public class CalculatorWorkflow : IWorkflow
    {
        ...
        {
            builder.StartWith<WriteLine>(x => x.TextExpression = new LiteralExpression("Welcome to Calculator Workflow! "))
                 .WithDisplayName("Welcome")
                 .WithDescription("Dispaly a Welcome message")
                 .Then<SetVariable>(x =>
                         {
                             x.VariableName = "exit";
                  ...
                  .Then<While>(
                          ...
                          whileActivity =>
                          {
                              whileActivity.When(OutcomeNames.Iterate)
